...
The MkDocs Material **`/guide`** site is for **local Docker only** — it is not part of this Apps bundle. Use Git docs or `make guide-site && make compose-up` → `http://127.0.0.1:8080/guide/`.
